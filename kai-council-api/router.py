...
KAI_TOOLS = [
    ...
    {"name": "consult_specialist", "description": "Consult a specialist or council advisor for domain expert input. Use 'dev' for engineering/architecture/stack decisions, 'creative' for brand/design/copy/campaign direction, 'devops' for infrastructure/containers/server questions. Use list_specialists to see all available.", "input_schema": {"type": "object", "properties": {"specialist": {"type": "string"}, "question": {"type": "string"}, "context": {"type": "string"}}, "required": ["specialist", "question"]}},
