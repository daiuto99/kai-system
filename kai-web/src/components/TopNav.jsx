...
const NAV_ITEMS = [
  ...
  { to: '/tasks',   label: 'Habits',  icon: <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg> },
]
    ...
    <nav style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <button onClick={onCapture} style={{
          ...
          padding: '7px 14px', borderRadius: 8, border: '1px solid #e8ecf1',
        ...
        <NavLink to="/settings" style={({ isActive }) => ({
          ...
          color: isActive ? '#ffffff' : '#6b7280', flexShrink: 0,
